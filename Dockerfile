...
RUN sed -i -e "s/;cgi.fix_pathinfo=1/cgi.fix_pathinfo=0/g" /etc/php5/fpm/php.ini && \
  ...
  sed -e "/;zend.multibyte =/a\zend_extension=/usr/lib/php5/ZendGuardLoader.so" -i /etc/php5/fpm/php.ini && \
  sed -e "/;zend.multibyte =/a\zend_extension=/usr/lib/php5/opcache.so" -i /etc/php5/fpm/php.ini && \
  sed -e "/;zend.multibyte =/a\zend_loader.enable=1" -i /etc/php5/fpm/php.ini && \
